...
public class ListenerFactory {
    ...
    public static MessageListener getListener(Message message, ContactBucket bucket, MessageDispacher server, TimestampedStore store)
            throws NoListenerException {
        Class listenerClass = messageToListener.get(message.getClass());
        if (listenerClass == null) {
            throw new NoListenerException("Message class :" + message.getClass());
        }
        try {
